...
// Define styles with makeStyles or use sx prop in MUI components
...
const Form = () => {
	...
	const isToggleModal = useSelector(state => state.student.isToggleModal);
	const selected = useSelector(state => state.student.selected);
