import headerc008 from './headerc008'
...
<div style='page-break-before: always;'></div>
	...
	<span style="display:inline-block;border-bottom: 1px solid black;width:70%;font-size:11px">${ esquemas(certificate.squemaCode) }</span>
	<label>del perfil</label>
