...
[hidden] { display: none; }
        ...
        body {
          ...
          margin: 0;
					padding: 0;
					margin: 0 auto;
					background-image: url(${config.API}/fotos-pdf/wallpaper.jpg);
		...
		<body>
			...
			<section class="container">
				<figure class="logo">
					<img class="logo-image" src="${config.API}/fotos-pdf/logo-occertimm.png" />
				</figure>
			...
			<section class="containerFirm">
				<div class="firmBox">
					<figure class="firmBoxFigure">
						<img class="logo-image" src="${config.API}/fotos-pdf/firm-walter.png" />
					</figure>
				...
				<div class="firmBox">
					<figure class="firmBoxFigure">
						<img class="logo-image" src="${config.API}/fotos-pdf/firm.png" />
					</figure>
					<div class="firmBox-user">
