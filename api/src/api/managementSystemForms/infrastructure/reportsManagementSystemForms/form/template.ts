import headerc001 from './headerc001'
...
function template(props, certificate, planning) {
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td style="border:1px solid black; font-size: 10px;height:25px">${esquemas(certificate.squemaCode)}</td>
  ...
  `
	...
	template += `
			...
			${ page4(props) }
			<div style='page-break-before: always;'></div>
			${ paget006(props, certificate) }
			<div style='page-break-before: always;'></div>
			${ page5(props, certificate, planning) }
			<div style='page-break-before: always;'></div>
			${ page6(props, certificate, planning) }

			<div style='page-break-before: always;'></div>
			${ page8(props, certificate) }
			<div style='page-break-before: always;'></div>
			${ page9(props, certificate, planning) }
			<div style='page-break-before: always;'></div>
			${ page10(props, planning) }
			<div style='page-break-before: always;'></div>
			${ page11(props) }
			<div style='page-break-before: always;'></div>
			${ page12(props, certificate, planning) }
			<div style='page-break-before: always;'></div>
			${ page13(props, certificate) }
