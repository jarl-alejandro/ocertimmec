...
function page(props, certificate) {
	...
	<section class="page2">
		...
		<div style="width:600px; height:400px; border:1px solid black;margin: 0 auto;">
			<img src="${config_1.default.API}/fotos-pdf/foto1.png" style="width:100%;height:100%" />
		</div>
<div style='page-break-before: always;'></div>
		${(0, headerc002_1.default)(2)}
		<br/>
		<div style="width:600px; height:400px; border:1px solid black;margin: 0 auto;">
			<img src="${config_1.default.API}/fotos-pdf/foto2.png" style="width:100%;height:100%" />
		</div>
		...
		<div style="width:500px; height:300px; border:1px solid black;margin: 0 auto;">
			<img src="${config_1.default.API}/fotos-pdf/foto3.png" style="width:100%;height:100%" />
		</div>
		...
		${(0, headerc002_1.default)(4)}
	<br/>
		<div style="width:500px; height:300px; border:1px solid black;margin: 0 auto;">
			<img src="${config_1.default.API}/fotos-pdf/foto4.png" style="width:100%;height:100%" />
		</div>
