    ...
    return `
		<table class="Header">
				<tr>
					...
					<td style="font-size: 12px">OCCERTIMM-C003</td>
				</tr>
				<tr>
				...
				<tr>
					<td rowspan="3" style="text-align: center;font-weight:500;font-size:14px">
						ACEPTACIÓN O NO ACEPTACIÓN DE LA APLICACIÓN PARA LA CERTIFICACIÓN
					</td>
				...
				<tr>
					...
					<td style="font-size: 12px">C003</td>
				</tr>
			</table>
	`;
}
exports.default = headerc003;
