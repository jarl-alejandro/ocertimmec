...
function emailFinishRegisterOnCourse(data, query) {
			...
			<section class="conatiner">
				<article class="card">
					...
					<p class="no-margin">Para completar tu registro en el perfil
						...
						<a href='${config_1.default.URL}/finalizar-inscripcion?id=${data}'>COMPLETAR TU REGISTRO AQUI</a>
					</p>
					<p></p>
...
exports.default = emailFinishRegisterOnCourse;
