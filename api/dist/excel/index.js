...
const student_1 = __importDefault(require("../api/courses/domain/student"));
const model_1 = __importDefault(require("../api/planning/domain/model"));
