            ...
            <table className="table table-borderless">
                ...
                <tr>
                    ...
                    <td width="70%">
                        <input
                            ...
                            type="text"
                            disabled={props.loadUser}
                            {...props.register('document', {required: true})}
                        />
                        {props.errors.name?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">El N° de cédula es obligatorio</div>}
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="70%">
                        ...
                        {props.errors.name?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">El nombre es obligatorio</div>}
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="70%">
                        ...
                        {props.errors.lastName?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">El apellido es obligatorio</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        />
                        {props.errors.birthdate?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">La fecha de nacimiento es obligatoria</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        />
                        {props.errors.direction?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">La dirección es obligatoria</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        />
                        {props.errors.province?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">La provincia es obligatoria</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        {props.errors.city?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">La ciudad es obligatoria</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        />
                        {props.errors.celphone?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">El celular es obligatorio</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        {props.errors.phone?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">El teléfono convencional es
                                obligatorio</div>}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="70%">
                        ...
                        {props.errors.email?.type === 'required' &&
                            <div className="invalid-feedback" role="alert">El correo electrónico es obligatorio</div>}
                    </td>
                </tr>
