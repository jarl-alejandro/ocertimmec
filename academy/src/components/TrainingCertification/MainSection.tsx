export default function MainSection({children, }: Readonly<{ children: React.ReactNode; }>) {
    return (
        <section className="position-relative pt-4 pt-sm-5">
            ...
            {/* SVG decoration */}
            <figure
                className="fill-primary opacity-1 position-absolute top-50 start-0 translate-middle-y ms-n7 mt-n8 d-none d-xxl-block">
