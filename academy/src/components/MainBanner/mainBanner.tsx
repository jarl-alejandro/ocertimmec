        ...
        <section className="position-relative  pb-0 pb-sm-5">
            ...
            <div className="container">
                <div className="row align-items-center justify-content-xl-between g-4 g-md-5">
                    {/* Left content START */}
                    <div
                        className="col-lg-7 col-xl-5 position-relative z-index-1 text-center text-lg-start mb-2 mb-md-9 mb-xl-0">
                        {/* Badge */}
                        <h6 className="mb-3 font-base bg-primary bg-opacity-10 text-primary py-2 px-4 rounded-2 d-inline-block">
                            { lang.get_started_with_occertimm }
                        </h6>
                        {/* Title */}
                        <h1 className="mb-4 display-6">
                            Desarrolla tus habilidades &amp;
                            <span className="position-relative d-inline-block">tu futuro brillante
                    ...
                    <div className="col-lg-5 col-xl-6 text-center position-relative">
                        {/* SVG decoration */}
                        <figure
                            className="position-absolute top-100 start-0 translate-middle mt-n6 ms-5 ps-5 d-none d-md-block">
                        ...
                        {/* Bell icon */}
                        <div
                            className="icon-lg bg-primary text-white rounded-4 shadow position-absolute top-0 start-100 translate-middle z-index-9 ms-n4 d-none d-md-block">
                            <i className="fas fa-bell"/>
                        </div>
                        {/* Live class */}
                        <div
                            className="p-3 card card-body shadow rounded-4 position-absolute top-0 start-0 translate-middle ms-5 z-index-1 d-none d-xl-block">
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="text-start ms-3">
                                    <h6 className="mb-0">Mecatrónica automotriz</h6>
                                    <p className="mb-0 small text-body">Hoy a la 1:00 pm</p>
                                    {/* Button */}
                                    <Link
                                        href="/"
                                        className="btn btn-sm btn-danger-soft mt-2 mb-0"
                                    >
                                        Únete ahora
                                    </Link>
                                </div>
                        ...
                        {/* Student review */}
                        <div
                            className="position-absolute top-100 start-100 translate-middle z-index-1 ms-n6 mt-n5 d-none d-xxl-block">
                            <div
                                className="card card-body shadow p-4 rounded-3 d-inline-block position-relative z-index-1">
                                {/* Icon */}
                                <div
                                    className="icon-lg bg-success rounded-circle position-absolute top-100 start-100 translate-middle">
                        ...
                        <div className=" position-relative">
                            {/* Yellow background */}
                            <div
                                className="bg-occertimm rounded-4 border border-white border-5 h-200px h-sm-300px shadow"/>
                            {/* Image */}
                            <Image
                                src={element06}
                                width={611}
