import BrandsSlider from "@/components/BecomeStudentNow/BrandsSlider";
import Form from "@/components/BecomeStudentNow/Form";
        ...
        <div className="container mt-5">
            <div className="row g-4 g-md-5 justify-content-between">
                ...
                <div className="col-lg-6 mb-5 mb-lg-0">
                    {/* Sub tittle */}
                    <h2 className="mb-3">¡Conéctate con nosotros a través de nuestros canales de contacto!</h2>
                    {/* List */}
                    ...
                    <div className="row justify-content-center">
                        {/* Sub tittle */}
                        <h5 className="mb-3">Marcas que depositan su confianza en nosotros</h5>
